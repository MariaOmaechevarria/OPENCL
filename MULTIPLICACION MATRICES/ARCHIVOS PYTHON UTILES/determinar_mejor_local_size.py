...
#FUNCION PARA FACTORIZAR: DEVUELVE UNA LISTA DE TUPLAS CON LOS FACTORES DE N
def factorizar(n):
    factores = []
...
#DEVUELVE UNA LISTA CON LOS LOCAL SIZES OPTIMOS
def optimal_local_size(global_size, max_compute_units, processing_elements):
    tam_x = global_size[0]
    tam_y = global_size[1]  
    
    # Factorizamos los processing elements
