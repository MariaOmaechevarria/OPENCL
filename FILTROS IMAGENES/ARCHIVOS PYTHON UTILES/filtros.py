...
filtro_mean35X = np.full((1, 35), 1/35, dtype=np.float32)
filtro_mean35Y = np.full((35, 1), 1/35, dtype=np.float32)

filtro_mean37X = np.full((1, 37), 1/37, dtype=np.float32)
filtro_mean37Y = np.full((37, 1), 1/37, dtype=np.float32)

filtro_mean39X = np.full((1, 39), 1/39, dtype=np.float32)
filtro_mean39Y = np.full((39, 1), 1/39, dtype=np.float32)

filtro_mean41X = np.full((1, 41), 1/41, dtype=np.float32)
filtro_mean41Y = np.full((41, 1), 1/41, dtype=np.float32)
