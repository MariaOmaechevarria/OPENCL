...
__kernel void kernel_mining2(
    ...
    // Definir el incremento por iteración (stride), igual al tamaño del grupo de trabajo global
    uint stride = get_global_size(0);

    // Bucle para probar múltiples nonces
    for (uint cur_nonce = global_id; cur_nonce < 0xFFFFFFFF; cur_nonce += stride) {
